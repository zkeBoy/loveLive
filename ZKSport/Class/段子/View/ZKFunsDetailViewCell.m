...
@interface ZKFunsDetailViewCell ()
...
@implementation ZKFunsDetailViewCell

- (void)setModel:(ZKFunsDetailModel *)model {
    _model = model;
    NSString * headURL = model.user.profile_image;
    ...
    self.supportNumber.text = [NSString stringWithFormat:@"%ld",(long)model.like_count];
    
    NSString * sex = model.user.sex;
